...
class SetTarget(Node):
    def __init__(self):
        ...
        self.pick_target_list = [[0.3,0.5,0.2],[0.3,0.0,0.2],[0.3,-0.5,0.2],[0.5,0.5,0.2],[0.5,0.0,0.2],[0.5,-0.5,0.2],
                                 [0.3,0.5,0.1],[0.3,0.0,0.1],[0.3,-0.5,0.1],[0.5,0.5,0.1],[0.5,0.0,0.1],[0.5,-0.5,0.1],
                                 [0.3,0.5,0.0],[0.3,0.0,0.0],[0.3,-0.5,0.0],[0.5,0.5,0.0],[0.5,0.0,0.0],[0.5,-0.5,0.0]]
